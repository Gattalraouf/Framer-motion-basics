...
function Letter() {
    return (
        <div
            style={{ width: "20%" }}
        >
            <svg id="b76bd6b3-ad77-41ff-b778-1d1d054fe577" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                ...
                <path
                    ...
                    transform="translate(-315 -194.16259)" style={{ fill: "#6c63ff" }} />
                <path
                ...
                <path
                    ...
                    transform="translate(-315 -194.16259)" fill="#3f3d56" />
                <circle cx="280" cy="150" r="45.7" fill="#aba7fa" />
            </svg>
        </div>
    )
}
